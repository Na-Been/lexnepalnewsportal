            ...
            <div class="col-span-12 lg:col-span-6">
                <div class="box">
                    <div class="grid grid-cols-12 mt-5">
                        ...
                        <div
                            class="intro-y col-span-12 sm:col-span-6  p-5 {{($errors->has('youtube_link')) ? 'has-error':''}} ">
                            <div class="mb-2 font-medium">Youtube Link</div>
                            {!! Form::url('youtube_link',getSetting('youtube_link'),['class'=>'input w-full border flex-1','placeholder'=>'Enter Youtube Link']) !!}
                            {!! $errors->first('youtube_link', '<div class="pristine-error text-theme-6 mt-2">:message</div>') !!}
                        </div>
                        <div
